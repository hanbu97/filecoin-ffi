    ...
    C: Circuit<E::Fr> + Send,
{
    ...
    info!("========================= finished multiexp a b_g1 b_g2 =========================");
    ...
    E: gpu::GpuEngine + MultiMillerLoop,
{
    ...
    let a = EvaluationDomain::all_in_one_ori(a, b, c, worker, fft_kern);
    // let geninv = a.geninv;
    // let e: <E>::Fr = E::Fr::multiplicative_generator();
    // let az: E::Fr = a.z(&e).invert().unwrap();
    // let log_nn = a.exp;

    // let devices = rust_gpu_tools::Device::all();
    // let mut k =
    //     ec_gpu_gen_mkcc::fft::FftKernel::<E>::create(&devices).expect("Cannot initialize kernel!");

    // let gpu_dur = now.elapsed().as_secs() * 1000 + now.elapsed().subsec_millis() as u64;
    // info!("all in one fft took {}ms.", gpu_dur);
    // info!("=============================================================================");
